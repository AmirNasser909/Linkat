...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2017 at 06:37 AM
...
INSERT INTO `assignment` (`assignment_ID`, `question`, `allowed_time`, `pl`, `assignment_type`) VALUES
(19, 'm4 far2a', '00:00:06', 1, 1),
(20, 'm4 far2a', '00:00:06', 1, 1),
(21, 'm4 far2a', '00:00:06', 1, 1),
(22, 'm4 far2a', '00:00:06', 1, 1),
(23, 'm4 far2a', '00:00:06', 1, 1),
(24, 'm4 far2a', '00:00:06', 1, 1),
(25, 'm4 far2a', '00:00:06', 1, 1),
(26, 'm4 far2a', '00:00:06', 1, 1),
(27, 'm4 far2a', '00:00:06', 1, 1),
(29, '../uploads/Sheet1.pdf', '23:59:59', 5, 3),
(30, '../uploads/C_Sheet22.pdf', '23:59:59', 5, 3);
...
INSERT INTO `assignment_answers` (`assignment_answers_ID`, `assignment_answers`, `right_answer`, `assignment`) VALUES
(41, 'ann0', 0, 19),
(42, 'ann1', 1, 19),
(43, 'ann2', 0, 19),
(44, 'ann3', 0, 19),
...
(233, 300, 4, '../uploads/16938747_1662270827400239_3774882421934680840_n.jpg', '5lasna??', 0),
(237, 304, 4, '../uploads/095b149d954a49a5fad7df30bb6872db.jpg', 'e2balone', 0);
...
(1, 'Home', 'http://localhost/Linkat_V02/View/index.php', ''),
(2, 'About us', 'http://localhost/Linkat_V02/View/aboutus.php', ''),
(3, 'Contact us', 'http://localhost/Linkat_V02/View/contactus.php', ''),
(4, 'Login', 'http://localhost/Linkat_V02/View/login.php', ''),
(5, 'Be instructor', 'http://localhost/Linkat_V02/View/beinstructor.php', ''),
(6, 'Register', 'http://localhost/Linkat_V02/View/Register.php', ''),
(9, 'Edit profile', 'http://localhost/Linkat_V02/View/edit_profile.php', ''),
(10, 'Delete account', 'http://localhost/Linkat_V02/View/delete_request', ''),
(11, 'Profile', 'http://localhost/Linkat_V02/View/ins_profile.php#', ''),
(14, 'Profile', 'http://localhost/Linkat_V02/View/Admin_profile.php#', ''),
(15, 'Logout', 'http://localhost/Linkat_V02/View/logout.php', ''),
(16, 'Profile', 'http://localhost/Linkat_V02/View/student_profile.php#', ''),
(17, 'Courses', 'http://localhost/Linkat_V02/View/course.php', 'course study ');
...
(300, 3, 'Esraa', 'Medhat', 'Esraa', 'Esraa@gmail.com', 'Esraa28', 0),
...
CREATE TABLE `user_notifications` (
  `user_notifications_ID` int(11) NOT NULL,
  `user_ID` int(11) NOT NULL,
...
ALTER TABLE `user_profile_pic`
  ...
  ADD KEY `user_profile_pic_ibfk_2` (`file_ID`);
...
--
ALTER TABLE `assignment`
  MODIFY `assignment_ID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
-- AUTO_INCREMENT for table `assignment_answers`
--
ALTER TABLE `assignment_answers`
  MODIFY `assignment_answers_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
--
...
--
ALTER TABLE `st_pl`
  MODIFY `st_pl_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `user_notifications`
  MODIFY `user_notifications_ID` int(11) NOT NULL AUTO_INCREMENT;
--
